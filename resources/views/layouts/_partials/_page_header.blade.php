<div class="sticky z-50 flex-1 px-4 flex justify-between sm:px-6 lg:max-w-6xl lg:mx-auto lg:px-8">
...
{{--        </form>--}}
    ...
    <div class="ml-4 flex items-center md:ml-6">
        ...
        <!-- Profile dropdown -->
        <div class="ml-3 relative" x-data="{ userSetting : false }">
            <div>
                <button
                    x-on:click=" userSetting = ! userSetting"
            ...
            <div
                ...
                x-transition:enter-end="transform opacity-100 scale-95"


                class="origin-top-right absolute right-0 mt-2 w-48 rounded-md shadow-lg py-1 bg-white ring-1 ring-black ring-opacity-5 focus:outline-none" role="menu" aria-orientation="vertical" aria-labelledby="user-menu-button" tabindex="-1" x-show="userSetting ">
                ...
                <form method="POST" action="{{ route('logout') }}" x-data>
                    ...
                    <a
                       ...
                       class="block px-4 py-2 text-sm text-gray-700" role="menuitem" tabindex="-1" id="user-menu-item-2">Logout</a>
