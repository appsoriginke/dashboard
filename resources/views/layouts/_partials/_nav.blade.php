<div class="px-2 space-y-1">
    ...
    @foreach(config('dashboard.navigations') as $name => $navigation)
        ...
        <a href="{{ route($navigation['url'] ) }}"
           class="text-gray-100 hover:text-white hover:bg-{{ config("dashboard.hover-theme-color") }}-500 group flex items-center px-2 py-2 text-sm leading-6 font-medium rounded-md"
           aria-current="page">
